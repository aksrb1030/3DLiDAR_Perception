...
int filter_neg_x_pos_y[23][9] = {{+3, +3, +3, +3, +3, +3, +3, +3, +3},
                                 {+3, +2, +2, +2, +2, +2, +2, +2, +3},
                                 {+3, +2, +2, +2, +2, +2, +2, +2, +3},
                                 {+3, +2, +2, +2, +2, +2, +2, +2, +3},
                                 {+3, +2, +2, +2, +2, +2, +2, +2, +3},
...
int filter_neg_x_neg_y[23][9] = {{+3, +3, +3, +3, +3, +3, +3, +3, +3},
                                 {+3, +2, +2, +2, +2, +2, +2, +2, +3},
                                 {+3, +2, +2, +2, +2, +2, +2, +2, +3},
                                 {+3, +2, +2, +2, +2, +2, +2, +2, +3},
                                 {+3, +2, +2, +2, +2, +2, +2, +2, +3},
...
int bus_filter_neg_x_pos_y[45][13] = {{+3, +3, +3, +3, +3, +3, +3, +3, +3, +3, +3, +3, +3},
                                      {+3, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +3},
                                      {+3, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +3},
                                      {+3, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +3},
                                      {+3, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +3},
...
int bus_filter_neg_x_neg_y[45][13] = {{+3, +3, +3, +3, +3, +3, +3, +3, +3, +3, +3, +3, +3},
                                      {+3, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +3},
                                      {+3, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +3},
                                      {+3, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +3},
                                      {+3, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +2, +3},
...
int main(int argc, char **argv)
{
  ...
  sub_segmentation_result = nh.subscribe("/detection/l_shaped/objects", 1, msgCallback);
