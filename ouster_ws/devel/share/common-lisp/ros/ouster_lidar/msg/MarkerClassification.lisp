...
(cl:defclass <MarkerClassification> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass MarkerClassification (<MarkerClassification>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <MarkerClassification>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'MarkerClassification)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ouster_lidar-msg:<MarkerClassification> is deprecated: use ouster_lidar-msg:MarkerClassification instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <MarkerClassification>))
