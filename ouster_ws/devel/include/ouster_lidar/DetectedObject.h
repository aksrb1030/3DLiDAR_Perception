// Generated by gencpp from file ouster_lidar/DetectedObject.msg
// DO NOT EDIT!


#ifndef OUSTER_LIDAR_MESSAGE_DETECTEDOBJECT_H
#define OUSTER_LIDAR_MESSAGE_DETECTEDOBJECT_H
...
struct DetectedObject_
{
  ...
  typedef boost::shared_ptr< ::ouster_lidar::DetectedObject_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ouster_lidar::DetectedObject_<ContainerAllocator> const> ConstPtr;

}; // struct DetectedObject_

typedef ::ouster_lidar::DetectedObject_<std::allocator<void> > DetectedObject;

typedef boost::shared_ptr< ::ouster_lidar::DetectedObject > DetectedObjectPtr;
typedef boost::shared_ptr< ::ouster_lidar::DetectedObject const> DetectedObjectConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ouster_lidar::DetectedObject_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ouster_lidar::DetectedObject_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ouster_lidar::DetectedObject_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ouster_lidar::DetectedObject_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ouster_lidar::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ouster_lidar::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ouster_lidar::DetectedObject_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ouster_lidar::DetectedObject_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ouster_lidar::DetectedObject_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ouster_lidar::DetectedObject_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3dd3b39b0fe0d68fULL;
  static const uint64_t static_value2 = 0xdfd6e1f764955599ULL;
};

template<class ContainerAllocator>
struct DataType< ::ouster_lidar::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::ouster_lidar::DetectedObject_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ouster_lidar::DetectedObject_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ouster_lidar::DetectedObject_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ouster_lidar::DetectedObject_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // OUSTER_LIDAR_MESSAGE_DETECTEDOBJECT_H
